...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', 'mongodb+srv://sohebkhataik25:ashkingpassssss@cluster0.ewksnis.mongodb.net/?appName=Cluster0') # MongoDB URI for the database  # MongoDB URI for the database
